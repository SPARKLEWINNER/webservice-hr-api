    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <div class="page-inner mt--5">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <?php $this->load->view('forms/categories/add/index'); ?>
                    </div>
                    <div class="col-md-8">
...
<script>
    function requests(e) {
        ...
        e.preventDefault();
        $.post({
            url: base_url + "client/store/add_new",
...
<script>
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            'ajax': '<?= base_url(); ?>store/request/categories/0',
            'columnDefs': [{
                    'targets': [0],
                    'searchable': false,
                    'orderable': false,
                ...
                },
                {
                    ...
                    'render': function(data, type, full, meta) {
                        return '<div class="list-action">' +
                            ...
                            '<div class="actions">' +
                            '<a class="text-primary action-text" href="<?= base_url(); ?>store/categories/edit/' + full[0] + '">Edit </a> | ' +
                            '<a class="text-danger action-text" href="<?= base_url(); ?>store/categories/remove/' + full[0] + '">Delete </a>' +
                            '</div>';
                        '</div>';
                    }
                }, {
